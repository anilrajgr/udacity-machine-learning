...
class LearningAgent(Agent):
    ...
    def reset(self, destination=None, testing=False):
        ...
        if testing:
            ...
            # self.epsilon = (1.0 / (self.trial_count * self.trial_count))
...
def run():
    ...
    agent = env.create_agent(LearningAgent, learning=True, alpha=0.999, epsilon=1.0)
    ...
    sim = Simulator(env, update_delay=0.0, optimized=True, log_metrics=True)
